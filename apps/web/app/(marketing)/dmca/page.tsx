...
<section className="doc-hero">
  <div className="container-doc">
    ...
    <h1>
      How to report <em>copyright infringement</em><br />
      on Boatcheckin.
    </h1>
  ...
  <div className="doc-body">
    ...
    <nav className="toc-nav" aria-label="Table of contents">
      ...
      <ul>
        ...
        <li><a href="#s2">§ 2 Designated Agent</a></li>
        <li><a href="#s3">§ 3 Submit a Notice</a></li>
        <li><a href="#s4">§ 4 How we respond</a></li>
        <li><a href="#s5">§ 5 Counter-Notice</a></li>
        <li><a href="#s6">§ 6 After Counter-Notice</a></li>
        <li><a href="#s7">§ 7 Repeat Infringers</a></li>
        <li><a href="#s8">§ 8 Trademark &amp; IP</a></li>
        <li><a href="#s9">§ 9 Good Faith</a></li>
    ...
    <div className="doc-content">
      ...
      <h2 id="s3"><span className="sec">§ 3</span>Submitting a Notice of Infringement</h2>
      ...
      <h2 id="s4"><span className="sec">§ 4</span>What we do when we receive a valid notice</h2>
      ...
      <h2 id="s7"><span className="sec">§ 7</span>Repeat Infringer Policy</h2>
      ...
      <h2 id="s8"><span className="sec">§ 8</span>Trademark and other IP concerns</h2>
